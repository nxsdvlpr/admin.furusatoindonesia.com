<template>
  ...
  >
    ...
    <NInputGroup :feedback="validation.error('page.counter')" label="Counter">
      <NInput v-model.number="form.page.counter" type="number" />
    </NInputGroup>
...
import useFormProjectStatistic from '@/components/program/project/useFormProjectStatistic'
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const { form, validation } = useFormProjectStatistic()
